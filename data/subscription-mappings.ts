...
export const subscriptionMappings: SubscriptionMapping[] = [
  {
    name: "Netflix",
    variants: ["netflix", "netflix premium", "netflix basic", "netflix standard"],
    color: "#E50914",
    logo: "netflix.svg"
  },
  {
    name: "Spotify",
    variants: ["spotify", "spotify premium", "spotify family", "spotify duo", "spotify student"],
    color: "#1DB954",
    logo: "spotify.svg"
  },
  {
  ...
  {
    name: "Apple Music",
    variants: ["apple music", "apple music family", "apple music student"],
    color: "#FA243C",
 ...
 */
export const findSubscriptionMapping = (serviceName: string): SubscriptionMapping | undefined => {
  if (!serviceName) return undefined;
  
  const normalizedName = serviceName.toLowerCase().trim();
  
  return subscriptionMappings.find(mapping => 
