    ...
    switch (sub.frequency.toLowerCase()) {
      case 'yearly':
        ...
        if (
          ...
          (result.getMonth() === today.getMonth() && result.getDate() < today.getDate())
        ) {
      ...
      case 'quarterly':
        ...
        if (currentMonthInQuarter > startQuarterMonth || 
            (currentMonthInQuarter === startQuarterMonth && today.getDate() > sub.dayOfMonth)) {
      ...
      case 'biannually':
        ...
        // If we're past the relative month or at the same month but past the day
        let nextHalfMonth;
        if (currentMonthInHalf > startBiMonth || 
            (currentMonthInHalf === startBiMonth && today.getDate() > sub.dayOfMonth)) {
    ...
    >
      ...
      <div className="space-y-2 mb-2 text-sm">
        <div className="flex justify-between">
          ...
          <span>{formatFrequency(subscription.frequency || 'monthly')}</span>
        </div>
        <div className="flex justify-between">
